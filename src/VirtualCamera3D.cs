...
public partial class VirtualCamera3D : Node3D, IVirtualCamera
{
	...
	public bool IsActive => GDirectorServer.Instance.CurrentActiveCamera3D == this;
	private CameraTransition3D? ActiveTransitionController => null;
	...
	public override void _Process(double delta)
	{
		...
		if (this.IsActive && this.ActiveTransitionController?.Ongoing != true) {
			GDirectorServer.Instance.ManagedCamera3D.GlobalPosition = this.GlobalPosition;
			GDirectorServer.Instance.ManagedCamera3D.GlobalRotation = this.GlobalRotation;
		}
